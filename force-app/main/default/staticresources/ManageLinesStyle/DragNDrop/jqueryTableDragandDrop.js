 ...
 *
 * Inside the onDrop method you can also call j$.tableDnD.serialize() this returns a string of the form
...
jQuery.tableDnD = {
	...
	if (ev.target.tagName == "TD" || ev.target.className == 'fa fa-bars fa-lg') {
